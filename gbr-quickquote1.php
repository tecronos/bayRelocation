 ...
 */
    ...
    */   
   define('CC_FB_TO_EMAIL', 'quote1@gbrmoving.com');
   /**
    ...
    */  
   define('CC_FB_AUTO_REPLY_SUBJECT', 'Moving Quote from GBR Moving');   
   /**
    ...
    * in the email.
    */  
   define('CC_FB_AUTO_REPLY_POSITION', 'top');
   
   /**
    * The page to redirect to after the form is submitted.
    */  
   define('CC_FB_RESULTS_REDIRECT', 'http://www.gbrmoving.com/quote_confirm1.htm');
   ...
   {      
      ...
      {      
         ...
         if(CC_FB_AUTO_REPLY)
         {
            $form_user_msg = parseMessage('Hi [NAME] -

We just received your submission for a quick moving quote and wanted to let you know that we\'re going to work on that right away. We know that you have a choice of movers in the Bay Area... and you have chosen wisely so far! 

We have been serving our happy customers for over 20 years and counting and have some of the highest honors, ratings, and reviews in the industry. We will do everything in our power to make you a happy customer as well. Please stand by for a call from us very soon to discuss your moving needs in more detail.

Thanks for choosing Golden Bay!

Best Regards

The Golden Bay Relocation Team
Phone: (415) 668-9562 

If you wish you can download the comprehensive quoter form here:
www.goldenbayrelocation.com/GBR-QUOTER1.pdf
